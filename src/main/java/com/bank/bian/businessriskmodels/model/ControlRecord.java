package com.bank.bian.businessriskmodels.model;
...
/**
 * The BIAN control record for this service domain: "Business Risk Model Development Project".
 *
 ...
 * to its asset type (Business Risk Model). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Business Risk Model Development Project";
